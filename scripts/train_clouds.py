...
data = numpy.load(open('/media/tam/rhino/work/projects/tesselo/data/cloud_training_data/classifier-collected-pixels-694.npz', 'rb'))
...
with open('/home/tam/Documents/repos/pixels/train/clouds_mlpclassifier_v2.pickle', 'wb') as fl:
    pickle.dump(clf, fl)


clf_re = pickle.load(open('/home/tam/Documents/repos/pixels/train/clouds_mlpclassifier_v2.pickle', 'rb'))
res = []
for i in range(23):
    st = int(i * 1e6)
    en = int((i+1) * 1e6)
    print(st)
    res.append(clf_re.predict(X[st:en, ]))
...
with open('/home/tam/Documents/repos/pixels/pixels/clf/classifier-l1c.pickle', 'wb') as fl:
    pickle.dump(clf, fl)
