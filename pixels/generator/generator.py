...
from pixels.generator.stac_utils import _load_dictionary, list_files_in_folder
...
class DataGenerator(keras.utils.Sequence):
    ...
    def download_and_parse_data(self):
        ...
        if self.download_data:
            ...
            with Pool(min(len(list_of_tifs), 50)) as p:
                p.starmap(
                    generator_utils.download_object_from_s3,
                    list_of_tifs,
                    [self.download_folder] * len(list_of_tifs),
                )
