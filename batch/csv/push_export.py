...
print(
    "Found {} geoms - array size is {} - tile group size is {}".format(
        nr_of_geoms, batch_array_size, tile_group_size
    )
)

# steps = [('2019-03-01', '2019-03-31'), ('2019-04-01', '2019-04-30'), ('2019-05-01', '2019-05-31'), ('2019-06-01', '2019-06-30')]
# steps = [('2019-03-01', '2019-03-31'), ('2019-04-01', '2019-04-30'), ('2019-06-01', '2019-06-30')]
...
{
    x["jobId"]: x["status"]
    for x in batch.describe_jobs(jobs=[job["jobId"] for job in all_jobs])["jobs"]
}
