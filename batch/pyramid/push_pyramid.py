...
for zoom in range(14, -1, -1):
    ...
    print(
        "Found {} tiles - array size is {} - tile group size is {}".format(
            nr_of_tiles, batch_array_size, tile_group_size
        )
    )
    ...
    job["containerOverrides"]["command"] = [
        "pyramid.py" if zoom == 14 else "pyramid_up.py"
    ]
